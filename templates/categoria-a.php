...
<section id="pagetitle" class="dark-mode">
	...
	<div class="col">
		<?php get_component('breadcrumbs', 'Pagina di categoria A', 'dark', true); ?>

		<h1 class="page-title">Pagina di categoria A</h1>
	</div>

</section>

<section id="categories">
	<div id="articles" class="vertical row between-content wrap">
